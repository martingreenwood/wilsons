...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="car-details">
		<section id="left-section">
				<div class="gallery"><img src="http://placehold.it/780x780"></div>
				<div class="secondary-images">
					<div class="enquiry column table">
						<ul class="cell middle">
							<li><a href="#"><i class="fa fa-download"></i>vehicle spec (pdf)</a></li>
							<li><a href="#"><i class="fa fa-envelope-o"></i>email to friend</a></li>
							<li><a href="#"><i class="fa fa-comment-o"></i>make enquiry</a></li>
						</ul>
					</div>
